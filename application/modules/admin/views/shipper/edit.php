        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Shipper</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <?= form_open('admin/shipper/simpan/'.base64_encode($data['shipper']->no),array('method'=>'post','class'=>'form-horizontal')) ?>
                <div class="box-body">
                    <div class="col-md-7">
                ...
                <div class="box-footer">
                    <div class="pull-right">
                        <?= anchor('admin/shipper/','Batal', array('class'=>'btn btn-default')) ?> &nbsp;
