...
class M_perusahaan extends CI_Model
{
    ...
    public function all_kategori_wilayah($param){
        if (!empty($param['wilayah'])){
            $this->db->where('id_wilayah',$param['wilayah']);
        }
        if (!empty($param['perusahaan'])){
            $this->db->where('s_id',$param['perusahaan']);
        }
        return $this->db->from('perusahaan')->where_in('s_kategori',$param['kategori'])->get();
    }
